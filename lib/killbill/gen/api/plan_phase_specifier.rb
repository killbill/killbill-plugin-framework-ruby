    ...
    module Model
      ...
      class PlanPhaseSpecifier
        ...
        def to_java()
          ...
          @product_category = Java::JavaLang::Enum.value_of( org.killbill.billing.catalog.api.ProductCategory.java_class, @product_category.to_s ) unless @product_category.nil?
          ...
          @phase_type = Java::JavaLang::Enum.value_of( org.killbill.billing.catalog.api.PhaseType.java_class, @phase_type.to_s ) unless @phase_type.nil?
