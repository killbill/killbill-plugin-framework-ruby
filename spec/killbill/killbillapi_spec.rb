...
describe Killbill::Plugin do
  ...
  before(:each) do
    ...
    @account = Killbill::Plugin::Gen::AccountData.new("external_key", "name", 3, "email", 1, Killbill::Plugin::Gen::Currency::USD, nil, Killbill::Plugin::Gen::DateTimeZone::UTC, "locale", "address1", nil,
"company_name", "city", "state_or_province", "postal_code", "country", "phone", true, false)
  ...
  it 'should test create/get_account_by_id' do
    ...
    account_created.should be_an_instance_of Killbill::Plugin::Gen::Account

    account_fetched = @kb_apis.get_account_by_id(account_created.id)
    account_fetched.should be_an_instance_of Killbill::Plugin::Gen::Account
    account_fetched.id.should be_an_instance_of Killbill::Plugin::Gen::UUID
    ...
    account_fetched.currency.should == Killbill::Plugin::Gen::Currency::USD
    account_fetched.locale.should == "locale"
    account_fetched.address1.should == "address1"
    account_fetched.address2.should == nil
    account_fetched.time_zone.should == Killbill::Plugin::Gen::DateTimeZone::UTC
