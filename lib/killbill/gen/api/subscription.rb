    ...
    module Model
      ...
      class Subscription
        ...
        def to_java()
          ...
          @state = Java::JavaLang::Enum.value_of( org.killbill.billing.entitlement.api.EntitlementState.java_class, @state.to_s ) unless @state.nil?

          # conversion for source_type [type = org.killbill.billing.entitlement.api.EntitlementSourceType]
          @source_type = Java::JavaLang::Enum.value_of( org.killbill.billing.entitlement.api.EntitlementSourceType.java_class, @source_type.to_s ) unless @source_type.nil?
          ...
          @last_active_product_category = Java::JavaLang::Enum.value_of( org.killbill.billing.catalog.api.ProductCategory.java_class, @last_active_product_category.to_s ) unless @last_active_product_category.nil?
