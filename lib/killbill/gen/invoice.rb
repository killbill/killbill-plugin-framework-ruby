  ...
  module Plugin
    module Model
      ...
      if original_charged_amount.nil?
        ...
        original_charged_amount = java.math.BigDecimal.new(original_charged_amount.respond_to?(:cents) ? original_charged_amount.cents : original_charged_amount.to_i)
      end
      ...
      if charged_amount.nil?
        ...
        charged_amount = java.math.BigDecimal.new(charged_amount.respond_to?(:cents) ? charged_amount.cents : charged_amount.to_i)
      end
      ...
      if credited_amount.nil?
        ...
        credited_amount = java.math.BigDecimal.new(credited_amount.respond_to?(:cents) ? credited_amount.cents : credited_amount.to_i)
      end
      ...
      if refunded_amount.nil?
        ...
        refunded_amount = java.math.BigDecimal.new(refunded_amount.respond_to?(:cents) ? refunded_amount.cents : refunded_amount.to_i)
      end
      ...
      if balance.nil?
        ...
        balance = java.math.BigDecimal.new(balance.respond_to?(:cents) ? balance.cents : balance.to_i)
      end
    ...
    def self.to_ruby(j_obj)
      ...
      invoice_items.each do |m|
        # conversion for m [type = com.ning.billing.invoice.api.InvoiceItem]
        m = j_obj.m
        m = Killbill::Plugin::Model::InvoiceItem.to_ruby(m) if !m.nil?
        tmp << m
      end
      invoice_items = tmp
      ...
      original_charged_amount = original_charged_amount.nil? ? 0 : original_charged_amount.multiply(java.math.BigDecimal.valueOf(100)).to_s.to_i

      # conversion for charged_amount [type = java.math.BigDecimal]
      charged_amount = j_obj.charged_amount
      charged_amount = charged_amount.nil? ? 0 : charged_amount.multiply(java.math.BigDecimal.valueOf(100)).to_s.to_i

      # conversion for credited_amount [type = java.math.BigDecimal]
      credited_amount = j_obj.credited_amount
      credited_amount = credited_amount.nil? ? 0 : credited_amount.multiply(java.math.BigDecimal.valueOf(100)).to_s.to_i

      # conversion for refunded_amount [type = java.math.BigDecimal]
      refunded_amount = j_obj.refunded_amount
      refunded_amount = refunded_amount.nil? ? 0 : refunded_amount.multiply(java.math.BigDecimal.valueOf(100)).to_s.to_i

      # conversion for balance [type = java.math.BigDecimal]
      balance = j_obj.balance
      balance = balance.nil? ? 0 : balance.multiply(java.math.BigDecimal.valueOf(100)).to_s.to_i
      ...
      b_value = (is_migration_invoice.java_kind_of? java.lang.Boolean) ? is_migration_invoice.boolean_value : is_migration_invoice
