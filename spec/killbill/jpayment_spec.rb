...
describe Killbill::Plugin::JPayment do
  ...
  it "should_test_charge_exception" do
    ...
    lambda { @jpayment.charge(@kb_payment_id, @kb_payment_method_id, @amount_in_cents) }.should raise_error Java::com.ning.billing.payment.plugin.api.PaymentPluginApiException
  end
  ...
  it "should_test_refund_exception" do
    @jpayment.real_payment.send(:raise_exception_on_next_calls)
    lambda { @jpayment.refund(@kb_payment_method_id, @amount_in_cents) }.should raise_error Java::com.ning.billing.payment.plugin.api.PaymentPluginApiException
  end

  it "should_test_add_payment_method_ok" do
    @jpayment.add_payment_method(@kb_account_id, @kb_payment_method_id, @payment_method_plugin, true)
  end
  ...
  it "should_get_payment_methods_ok" do
    output = @jpayment.get_payment_methods(@kb_account_id, true)
