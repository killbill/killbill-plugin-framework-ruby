    ...
    module Model
      ...
      class DryRunArguments
        ...
        def to_java()
          ...
          @action = Java::JavaLang::Enum.value_of( org.killbill.billing.entitlement.api.SubscriptionEventType.java_class, @action.to_s ) unless @action.nil?
          ...
          @billing_action_policy = Java::JavaLang::Enum.value_of( org.killbill.billing.catalog.api.BillingActionPolicy.java_class, @billing_action_policy.to_s ) unless @billing_action_policy.nil?
          self
        end
