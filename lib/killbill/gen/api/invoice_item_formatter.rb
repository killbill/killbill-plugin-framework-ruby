    ...
    module Model
      ...
      class InvoiceItemFormatter
        ...
        def to_java()
          ...
          @invoice_item_type = Java::JavaLang::Enum.value_of( org.killbill.billing.invoice.api.InvoiceItemType.java_class, @invoice_item_type.to_s ) unless @invoice_item_type.nil?
